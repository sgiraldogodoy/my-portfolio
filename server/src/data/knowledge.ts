...
export const knowledge: string[] = [
  ...
  "Project — AI for Impact: Inferring Suicidal Ideation via Smartphones (WPI MQP, 2025–2026, award-winning): part of the NIH-supported LEMURS app; re-architected a Kotlin Multiplatform mental-health app to ~80% shared iOS/Android code; implemented passive multi-modal smartphone data collection (motion, app usage, Bluetooth, surveys); machine-learning models reached 85.7% recall predicting suicide risk from screentime data. The app shipped publicly as 'WPI LEMURS' on the Apple App Store (https://apps.apple.com/us/app/wpi-lemurs/id6759763937) — code: https://github.com/sgiraldogodoy/lemurs-kmp-app",
  "Project — Hospital App Prototype for Brigham & Women's Hospital (WPI, 2024): backend technical lead on a 10-person Agile team; built hospital pathfinding, a map editor, and an EMR using React, TypeScript, Shadcn UI, Express, Prisma, and PostgreSQL; authored ~90% of the schema and the tRPC routes connecting frontend and backend. Code: https://github.com/sgiraldogodoy/Soft-Eng-App",
