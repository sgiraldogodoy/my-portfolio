...
export const knowledge: string[] = [
  ...
  "Project — AI for Impact: Inferring Suicidal Ideation via Smartphones (WPI MQP, 2025–2026, award-winning): part of the NIH-supported LEMURS app; re-architected a Kotlin Multiplatform mental-health app to ~80% shared iOS/Android code; implemented passive multi-modal smartphone data collection (motion, app usage, Bluetooth, surveys); machine-learning models reached 85.7% recall predicting suicide risk from screentime data.",
