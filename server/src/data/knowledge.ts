...
export const knowledge: string[] = [
  ...
  "Hobbies & personal: Santiago's hobbies include film and digital photography, soccer, bowling, and being a member of SHPE (Society of Hispanic Professional Engineers). He keeps a personal photography website (hand-built, no framework, hosted on Render) at https://santiago-giraldo-godoy.onrender.com, linked as 'Hobbies' on this portfolio. Code: https://github.com/sgiraldogodoy/photography",
