...
export const knowledge: string[] = [
  ...
  "Further education: Santiago has been accepted to a Master's in Artificial Intelligence at WPI, continuing his focus on AI after his bachelor's degree.",

  // --- Background, personality & working style ---
  "Background: Santiago is an international student originally from Bogotá, Colombia. He moved to the United States at age 18 to attend college at WPI. Spanish is his native language and he is bilingual in English.",
  "Personality (professional): Santiago describes himself as hardworking, a fast and active learner, patient, and organized, with a high work ethic. He loves building things people find useful and making a real impact.",
  "Personality (personal): On a personal level, Santiago is loyal, caring, and reliable, as well as authentic, passionate, and spontaneous from time to time.",
  "What he's like to work with: Working alongside Santiago day to day is fun and productive. He shares his ideas openly, asks for input when he's stuck, and isn't afraid to ask for help when needed. He makes time for everything, is always happy to help, and enjoys getting to know people; once he knows someone he's outgoing rather than shy.",
  "How he approaches projects: Santiago starts by understanding the scope, the tools, the goals, the challenges, and the progress so far. That tells him how much he already knows versus how much he needs to research, so he can adapt and ramp up quickly for each project.",
  "What he values in his work: Quality above all. Systems must work correctly and be secure. People trust a lot of sensitive information to the internet, and Santiago believes it is a developer's responsibility to build things as well and as securely as possible. This is the heart of his focus on secure development.",
  "Working under pressure and time management: Santiago works well under pressure and manages his time well. Years of juggling many extracurriculars have made him comfortable staying busy and balancing multiple commitments.",
  "What Santiago is looking for: He is open to a wide range of work, including freelance apps and websites of all kinds, and is also open to full-time opportunities (remote or in person in the US, and open to relocation). He does not have a fixed hourly rate and evaluates pricing per project. The best way to start a conversation about a project or role is the contact form.",
  "Motivation and goals: Santiago wants to help build the AI-driven future rather than just adapt to it. He has studied machine learning and shipped AI features in production, and now wants deeper foundations in how models work. His long-term goal is to work at the frontier of applied AI in high-impact, hard-engineering domains such as healthcare, enterprise systems, and intelligent infrastructure. He learns best by taking ideas from the classroom and immediately testing them against real systems.",
  ...
  "Hobbies: Santiago's hobbies include photography (he loves capturing moments and landscapes through his camera lens), soccer, movies and series, Dungeons & Dragons, bowling, and being a member of SHPE (Society of Hispanic Professional Engineers). He keeps a hand-built personal photography website (no framework, hosted on Render) at https://santiago-giraldo-godoy.onrender.com, linked as 'Hobbies' on this portfolio. Code: https://github.com/sgiraldogodoy/photography",
